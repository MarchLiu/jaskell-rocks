...
public class TryTest {
    ...
    public void testOr() {
        ...
        Try<String> success1 = new Success<>("hello");
        Try<String> success2 = new Success<>("world");
    ...
    public void testRecover() throws Exception {
        ...
        Failure<String> failure = new Failure<>(new RuntimeException());
    ...
    public void testRecoverToTry() throws Exception {
        ...
        Try<String> result = failure.recoverToTry(e -> new Success<>("hello"));
    ...
    public void testOrElseGet() throws Exception {
        ...
        String result = failure.orElseGet(new Success<>("hello"));
    ...
    public void testGetRecovery() throws Exception {
        ...
        String result = failure.getRecovery(e -> new Success<>("hello"));
    ...
    public void testFlatMap() throws Exception {
        ...
        Try<Integer> result = success.flatMap(s -> new Success<>(s.length()));
    ...
    public void testMap2() throws Exception {
        ...
        Try<String> result = success.map2(new Success<>(" world"), (s1, s2) -> s1 + s2);
    ...
    public void testFlatMap2() throws Exception {
        ...
        Try<String> result = success.flatMap2(Try.success("world"), (s1, s2) -> {
            return Try.success("%s %s".formatted(s1, s2));
        });
    ...
    public void testSuccess() throws Exception {
        ...
        assertTrue(try1 instanceof Success, "Try should be a Success");

        // Cast the result to a Success<T> object
        Success<Integer> success = (Success<Integer>) try1;

        // Assert that the value inside the Success object is 42
        assertEquals(success.get(), 42, "Value should be 42");
    }
    ...
    public void testFailure() {
        ...
        assertTrue(try1 instanceof Failure, "Try should be a Failure");

        // Cast the result to a Failure<T> object
        Failure<Integer> failure = (Failure<Integer>) try1;

        // Assert that the exception inside the Failure object is not null
        assertNotNull(failure.error(), "Exception should not be null");

        // Assert that the exception message matches the expected message
        assertEquals("Test exception", failure.error().getMessage(), "Exception message should match");
    }
    ...
    public void testApply() throws Exception {
        ...
        // Cast the result to a Success<U> object
        Success<? extends String> success = (Success<? extends String>) try1;

        // Assert that the value inside the Success object is "Hello, 42"
        assertEquals(success.get(), "Hello, 42", "Value should be 'Hello, 42'");
    }
